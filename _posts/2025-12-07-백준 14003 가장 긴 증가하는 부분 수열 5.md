...
수열 $A$ 에 대한 가장 긴 증가하는 부분 수열의 길이와 실제 수열을 구하는 문제로 전형적인 LIS 알고리즘을 활용하는 문제다. 수열의 크기 $N$ 이 최대 $1,000,000$ 이어서 2중 반복문 대신 [이분 탐색 LIS](/posts/lis-using-binary-search) 를 활용하면 간단하게 해결할 수 있다.
