---
title: "[알고리즘] 덱을 이용한 구간 최댓값 트릭 (Sliding Window Maximum)"
date: 2025-12-20
categories: [DS & Algo, Algorithm]
tags: [슬라이딩 윈도우, 우선순위 큐, 덱, 덱을 이용한 구간 최댓값 트릭]
toc: true
math: true
image: /assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/thumbnail.drawio.svg
---
...
![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo01.drawio.svg>)
...
![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo02.drawio.svg>)

단조 덱 (인덱스 $0$ 삽입)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo03.drawio.svg>)
...
![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo04.drawio.svg>)

단조 덱 (인덱스 $0$ 은 구간을 벗어나지 않음)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo05.drawio.svg>)

단조 덱 (인덱스 $0$ 의 값 $1$ 이 인덱스 $1$ 의 값 $5$ 보다 작아서 삭제하지 않음)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo06.drawio.svg>)

단조 덱 (인덱스 $1$ 삽입)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo07.drawio.svg>)
...
![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo08.drawio.svg>)

단조 덱 (인덱스 $0$ 은 구간을 벗어나지 않음)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo09.drawio.svg>)

단조 덱 (인덱스 $1$ 의 값 $5$ 가 인덱스 $2$ 의 값 $2$ 보다 크므로 삭제)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo10.drawio.svg>)

단조 덱 (인덱스 $0$ 의 값 $1$ 이 인덱스 $2$ 의 값 $2$ 보다 작아서 삭제하지 않음)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo11.drawio.svg>)

단조 덱 (인덱스 $2$ 삽입)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo12.drawio.svg>)
...
![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo13.drawio.svg>)

단조 덱 (인덱스 $0$ 은 구간을 벗어났으므로 삭제)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo14.drawio.svg>)

단조 덱 (인덱스 $2$ 의 값 $2$ 가 인덱스 $3$ 의 값 $3$ 보다 작아서 삭제하지 않음)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo15.drawio.svg>)

단조 덱 (인덱스 $3$ 삽입)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo16.drawio.svg>)
...
![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo17.drawio.svg>)

단조 덱 (인덱스 $4$ 삽입)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo18.drawio.svg>)
...
![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo19.drawio.svg>)

단조 덱 (인덱스 $2$는 구간을 벗어났으므로 삭제)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo20.drawio.svg>)

단조 덱 (인덱스 $4$ 의 값 $6$ 이 인덱스 $5$ 의 값 $2$ 보다 크므로 삭제)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo21.drawio.svg>)

단조 덱 (인덱스 $3$ 의 값 $3$ 이 인덱스 $5$ 의 값 $2$ 보다 크므로 삭제)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo22.drawio.svg>)

단조 덱 (인덱스 $5$ 삽입)

![](</assets/posts/2025-12/덱을%20이용한%20구간%20최댓값%20트릭%20(Sliding%20Window%20Maximum)/photo23.drawio.svg>)
...
- [백준 2433번 - The Sound of Silence](https://www.acmicpc.net/problem/2433)
