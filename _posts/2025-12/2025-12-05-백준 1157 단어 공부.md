...
int main() {
    ...
    int mx = *max_element(cntArr, cntArr + 26);

    if (count(cntArr, cntArr + 26, mx) > 1)
        cout << '?';
    else {
        int idx = max_element(cntArr, cntArr + 26) - cntArr;
        cout << char(idx + 'A');
    }
}
```
