---
title: "[자료구조/알고리즘] 0/1 배낭 문제 (0/1 Knapsack Problem)"
...
toc: true
math: true
image: /assets/posts/0-1-knapsack-problem/thumbnail.png
---
...
![](/assets/posts/0-1-knapsack-problem/photo03.drawio.svg)
...
![](/assets/posts/0-1-knapsack-problem/photo04.drawio.svg)

<br>

배낭 용량이 $5$ 인 경우도 마찬가지로 두 번째 물건을 담는다.

![](/assets/posts/0-1-knapsack-problem/photo05.drawio.svg)
...
![](/assets/posts/0-1-knapsack-problem/photo06.drawio.svg)

<br>

배낭 용량이 $7$인 경우도 마찬가지로 두 번째 물건을 담지 않는다.

![](/assets/posts/0-1-knapsack-problem/photo07.drawio.svg)
...
![](/assets/posts/0-1-knapsack-problem/photo08.drawio.svg)

<br>

네 번째 물건도 동일한 원리로 담으면 아래와 같이 된다. 배낭 용량이 부족해 현재 물건을 담을 수 없는 경우 현재 물건 이전까지를 고려했을 때 담을 수 있었는지를 판단해줘야 한다.

![](/assets/posts/0-1-knapsack-problem/photo09.drawio.svg)
...
![](/assets/posts/0-1-knapsack-problem/photo10.drawio.svg)

<br>

이제 두 번째 물건을 담는 경우 아래와 같은 과정으로 갱신이 발생한다.

![](/assets/posts/0-1-knapsack-problem/photo11.drawio.svg)

![](/assets/posts/0-1-knapsack-problem/photo12.drawio.svg)

![](/assets/posts/0-1-knapsack-problem/photo13.drawio.svg)

![](/assets/posts/0-1-knapsack-problem/photo14.drawio.svg)

<br>

세 번째 물건을 담는 경우 아래와 같은 과정으로 갱신이 발생한다.

![](/assets/posts/0-1-knapsack-problem/photo15.drawio.svg)

![](/assets/posts/0-1-knapsack-problem/photo16.drawio.svg)

![](/assets/posts/0-1-knapsack-problem/photo17.drawio.svg)

![](/assets/posts/0-1-knapsack-problem/photo18.drawio.svg)

![](/assets/posts/0-1-knapsack-problem/photo19.drawio.svg)

<br>

네 번째 물건을 담는 경우 아래와 같은 과정으로 갱신이 발생한다.

![](/assets/posts/0-1-knapsack-problem/photo20.drawio.svg)

![](/assets/posts/0-1-knapsack-problem/photo21.drawio.svg)

![](/assets/posts/0-1-knapsack-problem/photo22.drawio.svg)
...
- [BaekJoon 13448번 - SW 역량 테스트](https://www.acmicpc.net/problem/13448)
