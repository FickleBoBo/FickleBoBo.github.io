---
title: "[백준] 16493번 - 최대 페이지 수 [Java][C++]"
date: 2025-12-17
...
| 언어    | 시간   | 메모리   | 코드 길이 |
| ------- | ------ | -------- | --------- |
| Java 11 | 108 ms | 14316 KB | 1253 B    |

### 2. Bottom-Up 2차원 dp [Java]

| 언어    | 시간   | 메모리   | 코드 길이 |
| ------- | ------ | -------- | --------- |
| Java 11 | 112 ms | 14260 KB | 1126 B    |

### 3. Bottom-Up 1차원 dp [Java]

| 언어    | 시간  | 메모리   | 코드 길이 |
| ------- | ----- | -------- | --------- |
| Java 11 | 96 ms | 14388 KB | 966 B     |

### 4. 백트래킹 [C++]

| 언어   | 시간 | 메모리  | 코드 길이 |
| ------ | ---- | ------- | --------- |
| C++ 17 | 4 ms | 2020 KB | 744 B     |

### 5. Bottom-Up 2차원 dp [C++]

| 언어   | 시간 | 메모리  | 코드 길이 |
| ------ | ---- | ------- | --------- |
| C++ 17 | 0 ms | 2152 KB | 652 B     |
