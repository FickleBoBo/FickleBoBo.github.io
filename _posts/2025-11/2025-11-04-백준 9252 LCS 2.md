...
[백준 9251번 - LCS]({% post_url 2025-11/2025-11-04-백준 9251 LCS %}) 문제에서 LCS의 길이뿐만 아니라 실제 LCS 문자열도 출력해야 하는 문제다. 실제 LCS 문자열은 LCS의 길이 정보를 담고 있는 dp 배열을 역추적하는 방식으로 구할 수 있다.([LCS]({% post_url 2025-11/2025-11-16-최장 공통 부분 수열 (LCS, Longest Common Subsequence) %}))
