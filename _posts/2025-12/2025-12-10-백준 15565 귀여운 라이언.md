---
title: "[백준] 15565번 - 귀여운 라이언 [Java][C++]"
date: 2025-12-10
categories: [PS, BaekJoon]
tags: [슬라이딩 윈도우, 투 포인터 알고리즘]
toc: true
math: true
---
...
| 언어    | 시간   | 메모리   | 코드 길이 |
| ------- | ------ | -------- | --------- |
| Java 11 | 376 ms | 83888 KB | 1111 B    |

### 2. 투 포인터 [Java]

| 언어    | 시간   | 메모리   | 코드 길이 |
| ------- | ------ | -------- | --------- |
| Java 11 | 380 ms | 73684 KB | 1248 B    |

### 3. 슬라이딩 윈도우 [C++]

| 언어   | 시간  | 메모리  | 코드 길이 |
| ------ | ----- | ------- | --------- |
| C++ 17 | 56 ms | 5220 KB | 698 B     |

### 4. 투 포인터 [C++]

| 언어   | 시간  | 메모리  | 코드 길이 |
| ------ | ----- | ------- | --------- |
| C++ 17 | 56 ms | 5908 KB | 699 B     |
