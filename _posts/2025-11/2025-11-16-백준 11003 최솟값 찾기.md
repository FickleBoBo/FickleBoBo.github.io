...
[덱을 이용한 구간 최대/최소 트릭]({% post_url 2025-11/2025-11-16-덱을 이용한 구간 최대／최소 트릭 (Sliding Window Maximum／Minimum with a Monotonic Deque) %}) 의 대표적인 문제로 슬라이딩 윈도우와 단조 덱을 활용하여 해결할 수 있다.
