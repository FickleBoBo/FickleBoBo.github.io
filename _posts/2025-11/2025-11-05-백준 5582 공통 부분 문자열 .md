...
두 문자열의 가장 긴 공통 부분 문자열을 찾는 문제로 [LCS]({% post_url 2025-11/2025-11-16-최장 공통 부분 문자열 (LCS, Longest Common Substring) %}) 를 활용하면 해결할 수 있다. 최장 공통 부분 수열이 아니라 최장 공통 부분 문자열임에 주의해야 한다.
