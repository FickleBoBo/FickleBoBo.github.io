...
tags:
  [Number Theory, Primality Test, Prime Factorization, Sieve of Eratosthenes]
toc: true
math: true
---
...
주어진 수들을 소인수분해한 결과를 출력하는 문제로 [에라토스테네스의 체](/posts/sieve-of-eratosthenes) 를 활용해 소수들을 얻고 이 소수들로 $1$ 이 될 때까지 반복적으로 나누면 된다.
