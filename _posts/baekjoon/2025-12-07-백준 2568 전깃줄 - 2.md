...
[BaekJoon 2565번 - 전깃줄](/posts/baekjoon-2565) 문제에서 전깃줄의 개수가 최대 $100,000$ 으로 커지고 없애야 하는 전깃줄까지 출력해야 하는 문제다. 이전 문제는 2중 반복문을 활용한 LIS로 해결할 수 있었다면 이제는 [이분 탐색을 활용한 LIS](/posts/lis-using-binary-search) 를 활용하면 해결할 수 있다.
