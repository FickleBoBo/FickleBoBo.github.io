...
toc: true
math: true
image: /assets/posts/2025-12/슬라이딩%20윈도우%20(Sliding%20Window)/thumbnail.drawio.svg
---

## 1. 슬라이딩 윈도우

슬라이딩 윈도우(Sliding Window)는 배열이나 리스트와 같은 데이터 구조에서 연속된 부분 배열의 합이나 최댓값 등을 효율적으로 계산하는 데 사용되는 일종의 테크닉이다. 주로 고정된 크기의 윈도우를 활용하여 데이터를 처리하며 이 과정에서 반복적인 계산을 줄여 시간복잡도를 낮출 수 있다.
...
![](</assets/posts/2025-12/슬라이딩%20윈도우%20(Sliding%20Window)/photo01.drawio.svg>)
...
![](</assets/posts/2025-12/슬라이딩%20윈도우%20(Sliding%20Window)/photo02.drawio.svg>)
...
![](</assets/posts/2025-12/슬라이딩%20윈도우%20(Sliding%20Window)/photo03.drawio.svg>)
...
![](</assets/posts/2025-12/슬라이딩%20윈도우%20(Sliding%20Window)/photo04.drawio.svg>)
...
![](</assets/posts/2025-12/슬라이딩%20윈도우%20(Sliding%20Window)/photo05.drawio.svg>)
...
![](</assets/posts/2025-12/슬라이딩%20윈도우%20(Sliding%20Window)/photo06.drawio.svg>)
...
![](</assets/posts/2025-12/슬라이딩%20윈도우%20(Sliding%20Window)/photo07.drawio.svg>)
...
![](</assets/posts/2025-12/슬라이딩%20윈도우%20(Sliding%20Window)/photo08.drawio.svg>)
...
$$
i = 6,\qquad sum - arr[5] + arr[9]
$$

![](</assets/posts/2025-12/슬라이딩%20윈도우%20(Sliding%20Window)/photo08.drawio.svg>)

위 과정을 통해 매번 구간의 합을 구간의 처음부터 하나하나 더해서 계산하는 것이 아니라 양 끝 정보만 처리함으로써 기존에 각 구간 당 $K$ 번의 연산이 필요했던 것 대비 $2$ 번의 연산만 필요하다. 이렇듯 윈도우가 미끄러지듯이 이동하며 윈도우 내 정보를 효율적으로 처리하는 테크닉이 슬라이딩 윈도우이다.
...
- [백준 24499번 - blobyum](https://www.acmicpc.net/problem/24499)
- [백준 15565번 - 귀여운 라이언](https://www.acmicpc.net/problem/15565)
- [백준 1522번 - 문자열 교환](https://www.acmicpc.net/problem/1522)
- [백준 1593번 - 문자 해독](https://www.acmicpc.net/problem/1593)
